...
function respostaOtimoBom(){
    ...
    var percOtimoBom=(somaOtimoBom*100)/totalPessoas;
    return (percOtimoBom)
}
...
function dadosLevantados(){
    document.getElementById("dadosLevantados").innerHTML = "A média da idade do público foi de " + mediaIdade() + " anos sendo " + 
                                                                    ...
                                                                    idadeMaisNova() + " a idade da pessoa mais nova." +
                                                                    "\n" + "O número de pessoas que avaliou o filme como péssimo foi de " +
                                                                    respostaPessimo() + " e a porcentagem de bom ou ótimo foi de " +
                                                                    respostaOtimoBom()+ "% ." + "\n" + "Dos presentes haviam " + 
                                                                    numHM();
}
